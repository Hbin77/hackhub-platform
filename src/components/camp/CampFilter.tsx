...
export default function CampFilter({ hackathons, selected, onChange }: CampFilterProps) {
  return (
    <select
      ...
      className="rounded-lg border border-border bg-bg-elevated px-4 py-2.5 text-sm text-text focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
    >
