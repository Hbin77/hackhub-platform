...
export default function HeroBanner({ teamCount, totalPrize, hackathonCount }: HeroBannerProps) {
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <div className="mt-16 flex items-center justify-center gap-8 sm:gap-16">
          <div className="text-center">
            <p className="font-display text-3xl font-bold text-text">{teamCount}</p>
            <p className="mt-1 text-sm text-text-secondary">참가 팀</p>
          </div>
          <div className="h-8 w-px bg-border" />
          <div className="text-center">
            <p className="font-display text-3xl font-bold gradient-text">{formatPrize(totalPrize)}</p>
            <p className="mt-1 text-sm text-text-secondary">총 상금</p>
          </div>
          <div className="h-8 w-px bg-border" />
          <div className="text-center">
            <p className="font-display text-3xl font-bold text-text">{hackathonCount}</p>
